...
//            MySqlCommand MyCom = new MySqlCommand("INSERT INTO Trade(teamID, playerID, date, type, oldprice, ID) VALUES (@teamID, @playerID, @date, @type, @oldprice, @ID)", conn);
//            MyCom.Parameters.AddWithValue("@teamID", t.teamID);
//            MyCom.Parameters.AddWithValue("@playerID", t.playerID);
//            MyCom.Parameters.AddWithValue("@date", t.date);
//            MyCom.Parameters.AddWithValue("@type", t.type);
//            MyCom.Parameters.AddWithValue("@oldprice", t.oldprice);
//            MyCom.Parameters.AddWithValue("@ID", t.ID);
//            conn.Open();
